...
GCC     := ~/CA/rv32ima/bin/riscv32-unknown-elf-gcc
GPP     := ~/CA/rv32ima/bin/riscv32-unknown-elf-g++
OBJCOPY := ~/CA/rv32ima/bin/riscv32-unknown-elf-objcopy
OBJDUMP := ~/CA/rv32ima/bin/riscv32-unknown-elf-objdump
VIVADO  := /mnt/share/tools/Xilinx/Vivado/2024.2/bin/vivado
VPP     := /mnt/share/tools/Xilinx/Vitis/2024.2/bin/v++
